...
#_ *Japy is efficient*. As a stream parser, japy does not make data copies or memory-greedy. It is also built to avoid memory allocations and any other potentially useless work (like building DOM of the entire document).
